"""
Django settings for InteractiveOutdoorNetwork project.
...
SECRET_KEY = '=a1*yv%k2h)^sjyv7vg)+#$iuqf+dupl(3af=lq4y=7-w4qf#j'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [u'verycumbersome.pythonanywhere.com', '127.0.0.1']
...
ROOT_URLCONF = 'InteractiveOutdoorNetwork.urls'
...
WSGI_APPLICATION = 'InteractiveOutdoorNetwork.wsgi.application'
